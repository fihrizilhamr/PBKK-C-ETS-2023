...
<body>
    ...
    <div class="wrapper">
        ...
        <br><br>
        <!-- form -->
        <form action="{{ route('form_product') }}" method="POST" enctype="multipart/form-data">
            <!-- logo dalam form -->
            <div class="logo">
            ...
            <input type="text" name="Kecacatan" required>
            <br>

            <label for="Jumlah">Jumlah:</label>
            <input type="number" name="Jumlah" step="1.0" required>
            <br>
